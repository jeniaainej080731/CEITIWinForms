...
namespace Lab5_netFramework
{
    public partial class MainForm : Form
    {
        ...
        private void CalculateButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Сначала введите размеры фигуры!", "Ошибка",
        ...
        private string AskForDesignation()
        {
            ...
            {
                string figure = FigureComboBox.SelectedItem.ToString();
                string prompt = figure switch
                {
                    "Circle" => "Enter 1 capital letter:",
                    "Triangle" => "Enter 3 capital letters:",
                    _ => "Enter 4 capital letters:"
                };
                string defaultValue = figure switch
                {
                    "Circle" => "C",
                    "Triangle" => "ABC",
                    _ => "ABCD"
